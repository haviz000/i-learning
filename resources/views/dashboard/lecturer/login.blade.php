					...
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								<h2>I-Learning</h2>
								<p>Are you student ?</p>
								<a href="{{ route('user.login') }}" class="btn btn-white btn-outline-white">Sign Up as student</a>
							</div>
			      </div>
						<div class="login-wrap p-4 p-lg-5">
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h3 class="mb-4">Log In for Lecturer</h3>
			      		</div>
			      	</div>
							<form class="signin-form" action="{{ route('lecturer.check') }}" method="post" autocomplete="off">
								@if(Session::get('fail'))
