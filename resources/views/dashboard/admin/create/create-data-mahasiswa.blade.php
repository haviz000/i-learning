...
@section('content')
<div class="container">
	<form method="post" action="{{ route('admin.create-mahasiswa') }}">
		{{ csrf_field() }}
		<div class="form-group mb-3">
  		...
  		<div class="form-group mb-3">
  			...
  			<input type="text" input id="jurusan" class="form-control form-control @error('jurusan') is-invalid @enderror" placeholder="jurusan" name="jurusan" value="{{ old('jurusan') }}" required autocomplete="jurusan" autofocus>
  										@error('jurusan')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
